...
public class DriveConstants {
    ...
    private static final MotorConfigurationType MOTOR_CONFIG =
            MotorConfigurationType.getMotorType(GoBILDA5202_435RPM.class);
    ...
    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(10, 1.1, 9);
    //public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(14.4, 1.1, 14);
    /*
    ...
    public static double getTicksPerInch() {
        return (MOTOR_CONFIG.getTicksPerRev() / 2 * WHEEL_RADIUS * Math.PI * GEAR_RATIO);
    }

    public static double getTicksPerCM() {
        return INCHtoCM(getTicksPerInch());
    }
