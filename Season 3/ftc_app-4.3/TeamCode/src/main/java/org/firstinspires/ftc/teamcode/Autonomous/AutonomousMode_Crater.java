    ...
    public void runOpMode() throws InterruptedException{
        ...
        switch(gold) {
            case 0:
                ...
                sleep(100);
                mov.move_forwards_cm(60, 0.10); //move gold
                sleep(100);
                mov.move_forwards_cm(-20, 0.3); //move to previous location
                sleep(100);
                mov.rotate(770,0.3);//rotate right
                sleep(100);
                mov.move_forwards_cm(-20, 0.2);
                sleep(100);
                mov.strafe(1450, 0.2);//strafe left towards the wall
                sleep(100);
                ...
                sleep(100);
                mov.strafe(-35, 0.15); //strafe right
                sleep(100);
                mov.move_forwards_cm(60, 0.6); //move towards crater
                horizontalArm.basculanta.setState(HorizontalArm.Basculanta.State.DOWN);//basc down
                sleep(100);
                horizontalArm.matura.setState(HorizontalArm.Matura.State.IN);
                break;
            case 1:
                mov.rotate(-750, 0.5); //rotate to face middle mineral
                sleep(100);
                mov.move_forwards_cm(50, 0.2); //move gold 
                sleep(100);
                mov.move_forwards_cm(-50, 0.2); //move to previous position
                sleep(100);
                mov.rotate(1120, 0.3); //rotate right
                sleep(100);
                mov.strafe(-225, 0.2); // strafe right to avoid silver mineral, was -255
                sleep(100);
                mov.move_forwards_cm(-115, 0.2);//la culoar
                sleep(100);
            ...
            case 2:
                mov.rotate(-400, 0.5);
                sleep(100);
                mov.move_forwards_cm(57, 0.2);
                sleep(100);
                mov.move_forwards_cm(-57, 0.2);
                sleep(100);
                mov.strafe(200, 0.15);
                sleep(100);
                mov.move_forwards_cm(-20, 0.15);
                sleep(100);
                mov.strafe(1200, 0.3);//strafe left towards the wall
                sleep(100);
                mov.strafe(500, 0.15);//strafe left
                sleep(100);
                mov.move_forwards_cm(-140, 0.2); //move backwards to depot
                sleep(100);
                marker.down();
               ...
               // mov.rotate(-60,0.2);//rotate towards crater 
                ...
                mov.move_forwards_cm(80, 0.3); //move towards crater
                sleep(100);
                mov.strafe(100, 0.15); //strafe left into wall to correct direction
                sleep(100);
                mov.move_forwards_cm(80, 0.3); //move towards crater
                horizontalArm.basculanta.setState(HorizontalArm.Basculanta.State.DOWN);//basc down
                sleep(100);
